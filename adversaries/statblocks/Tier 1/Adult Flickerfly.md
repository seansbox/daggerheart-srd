...
desc: A winged insect the size of a large hourse with iridescent scales and wings that move too fast to track.
...
feats:
  ...
  - name: Hallucinatory Breath - Countdown (Loop 1d6)
